...
const CustomButton = ({
    ...
    return (
        ...
        >
            <span className="ease absolute top-1/2 h-0 w-64   group-hover:h-64 origin-center -translate-x-20 rotate-45 bg-black transition-all duration-300 group-hover:-translate-y-32"></span>
